...
> {
  ...
  private checkRedundantQueryParameters() {
    ...
    if (resolvedMask instanceof URL && resolvedMask.search !== '') {
      ...
      console.warn(`\
[SWAP] Found a redundant usage of query parameters in the request handler URL for "${method} ${mask}". Please match against a path instead, and access query parameters in the response resolver function:
